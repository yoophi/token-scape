...
- 보기 모드에 따라 창 크기가 조정됩니다. 간단히 보기는 더 작은 창을 사용하고, 자세히 보기는 더 큰 창을 사용합니다.
...
```sh
make app
open .build/release/CodexUsageViewer.app
```
...
- `CodexUsageViewer`: inbound adapter. SwiftUI/AppKit UI, 메뉴바 통합, timer, formatting
...
make test
make app
plutil -lint .build/release/CodexUsageViewer.app/Contents/Info.plist
open .build/release/CodexUsageViewer.app
```
